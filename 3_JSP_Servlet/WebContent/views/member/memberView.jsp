		...
		<form action="views/member/memberUpdateForm.jsp" method="post" id="myInfoForm" name="myInfoForm">
			<table>
				...
				<tr>
					...
					<td>
					<%= phone %>
						<input type="hidden" maxlength="11" name="phone" value="<%= phone %>">
					</td>
				</tr>
				<tr>
					<td>이메일</td>
				...
				<tr>
					...
					<td>
						...
						<!-- <input type="hidden" id="sports" name="interest" value="운동">
						<label for="sports">운동</label>
						<input type="hidden" id="climbing" name="interest" value="등산">
						<label for="climbing">등산</label>
						<input type="hidden" id="fishing" name="interest" value="낚시">
						<label for="fishing">낚시</label>
						<input type="hidden" id="cooking" name="interest" value="요리">
						<label for="cooking">요리</label>
						<input type="hidden" id="game" name="interest" value="게임">
						<label for="game">게임</label>
						<input type="hidden" id="etc" name="interest" value="기타">
