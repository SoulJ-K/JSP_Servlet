...
<% Notice notice = (Notice)request.getAttribute("no"); %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
		...
		<div class="tableArea">
			<form action="views/notice/noticeUpdateForm.jsp" id="detailForm" name="detailForm">
				<table>
					<tr>
						<th>제목</th>
						<td colspan="3"><input type="text" size="50" name="title" value="<%= notice.getnTitle()%>"></td>				
					</tr>
					<tr>
						<th>작성자</th>
						<td>
						...
						<th>작성일</th>
						<td><input type="date" name="date" value="<%= notice.getnDate() %>"></td>
					</tr>
					<tr>
						<th>내용</th>
					</tr>
					<tr>
						<td colspan="4">
							<textarea name="content" cols="60" rows="15" style="resize:none;"><%= notice.getnContent() %></textarea>
						</td>
					</tr>
				</table>
				...
				<div align="center">
					<button type="submit" id="insertNoBtn">수정</button>
