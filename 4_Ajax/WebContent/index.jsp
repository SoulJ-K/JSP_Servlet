...
<body>
		...
		$('#getUserInfoBtn3').click(function(){
			$.ajax({
				...
				success: function(data){
					...
					for(var i in data){
						var user = data[i];
						Str += user.userNo + ", " + user.userName + ", " + user.userNation + "\n";
					}
	...
	<textarea rows=5 cols=40 id="textarea6" class="test"></textarea>
	<script>
		...
		$('#userInfoBtn').click(function(){
			$.ajax({
				...
				success : function(data){
					...
					$tableBody = $('#userInfoTable tbody');		//jQuery로 만든 객체라는 뜻의 $. 
					$tableBody.html("");
