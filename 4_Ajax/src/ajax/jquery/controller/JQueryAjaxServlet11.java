...
public class JQueryAjaxServlet11 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * JSONObject userObj = null; JSONArray userArr = new JSONArray();
		 * 
		 * for(User user : userList) { userObj = new JSONObject(); userObj.put("userNo",
		 * user.getUserNo()); userObj.put("userName", user.getUserName());
		 ...
		 *  out.println(userArr); out.flush(); out.close();
		 */
