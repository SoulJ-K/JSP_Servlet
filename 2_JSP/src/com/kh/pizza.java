...
public class pizza extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case "콤비네이션 피자" : price = 6000; break;
		case "포테이토 피자" : price = 7000; break;
		case "고구마 피자" : price = 7000; break;
		case "불고기 피자" : price = 8000; break;
		}
		
		for(int i = 0; i < top.length; i++) {
			switch(top[i]) {
			case "고구마 무스" : price += 1000; break;
			case "콘크림 무스" : price += 1500; break;
		...
		String tops = String.join(" ", top);
		req.setAttribute("top", tops);
