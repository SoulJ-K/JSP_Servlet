...
<body>
	...
	<p>
		...
		uri : 실제 웹 상 주소가 아니라 태그 라이브러리를 나타내는 식별자로
			  이 지시자를 통해 작성한 태그 이름과 매칭되는 자바 코드를 찾음
	</p>
	
	<h2> c: set 태그</h2><!-- 변수 선언, scope지정 안하면 기본으로 page -->
	<!-- 1. 변수의 선언  -->
	...
	<!-- request스코프에 9999값을 가진 result 변수 생성 -->
	<c:set var="result" value="9999" scope="request"></c:set>
